...
fprintf('Numero de palavras unicas geradas para n=%d é %d\n',size,length(lista));
...
for i = 1:length(lista)
    ...
    fprintf('Probabilidade de gerar uma palavra portuguesa valida para n=%d é %f\n',size,soma);
